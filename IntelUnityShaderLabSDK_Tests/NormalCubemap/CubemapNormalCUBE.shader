Shader "Editor/CubemapNormalCUBE"
{
    Properties
    {
        ...
        _CubemapNormalCUBE("CubemapNormalCUBE", Cube) = "" {}
        _CubemapBumpCUBE("CubemapBumpCUBE", Cube) = "" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            samplerCUBE _CubemapNormalCUBE;
            fixed4 _CubemapNormalCUBE_ST;
            samplerCUBE _CubemapBumpCUBE;
            fixed4 _CubemapBumpCUBE_ST;
            ...
            appdata_cubemap vertex(appdata_full input)
            {
                ...
                //fixed4 bumpMap = texCUBE(_CubemapBumpCUBE, output.sample);
                fixed4 incorrectLODBumpMap = texCUBElod(_CubemapBumpCUBE, fixed4((input.texcoord * _CubemapBumpCUBE_ST).xyz, 0.0));
            ...
            fixed4 fragment(appdata_cubemap input) : COLOR
            {
                ...
                //fixed3 normalMap = texCUBE(_CubemapNormalCUBE, input.sample) * 360.0;
                fixed3 incorrectNormalMap = texCUBE(_CubemapNormalCUBE, fixed3((input.sample * _CubemapNormalCUBE_ST.xy) + _CubemapNormalCUBE_ST.zw, 0.0)) * 360.0;
