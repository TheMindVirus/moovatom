    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            [maxvertexcount(4)] void geometry_shader(triangle appdata_vertex input[3], inout TriangleStream<appdata_geometry> triangles)
            {
                ...
                geometry[0].uv = geometry[0].vertex;
                geometry[1].uv = geometry[1].vertex;
                geometry[2].uv = geometry[2].vertex;
                geometry[3].uv = geometry[3].vertex;
